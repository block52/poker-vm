        ...
        <VStack spacing={12} align="stretch">
          ...
          <Box textAlign="center" py={20}>
            ...
            <Text fontSize="xl" mb={8}>
              Explore blocks, transactions, and addresses on the Block 52
              network.
            </Text>
            <Center>
              <Box width={500}>
