        ...
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50">
            <div className="bg-gradient-to-b from-gray-800 to-gray-900 p-8 rounded-xl shadow-2xl w-96 border border-gray-700 overflow-hidden relative">
                ...
                <div className="mb-6">
                    ...
                    <select disabled value="$0.10 / $0.20" className="w-full p-2 rounded bg-gray-700 text-white border border-gray-600 text-sm">
                ...
                {/* Wait for Big Blind */}
                <div className="flex items-center display-flex mb-6">
                    <input
                        type="checkbox"
                        className="mr-2"
