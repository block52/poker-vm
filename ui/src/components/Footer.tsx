                ...
                {hasMuckAction && (
                    <div className="flex justify-center mb-2 lg:mb-3">
                        <button
                            ...
                            disabled={loadingAction !== null}
                            className="btn-muck text-white font-bold py-2 lg:py-3 px-6 lg:px-8 rounded-lg shadow-lg text-sm lg:text-base border-2 transition-all duration-300 flex items-center justify-center gap-2 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {loadingAction === "muck" ? (
                                <LoadingSpinner size="sm" />
                            ) : (
                            ...
                            {loadingAction === "muck" ? "MUCKING..." : "MUCK CARDS"}
                        </button>
                    </div>
                )}
