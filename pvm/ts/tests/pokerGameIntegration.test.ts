import { PokerGameIntegration } from '../src/models/pokerGameIntegration';
import { HandType } from '../src/models/pokerSolver';
...
describe('PokerGameIntegration', () => {
    ...
    describe('Hand Description Formatting', () => {
        test('should format all hand types correctly', () => {
            ...
            const { Deck } = require('../src/models/deck');
            const { PokerSolver } = require('../src/models/pokerSolver');
