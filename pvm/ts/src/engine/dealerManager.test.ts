...
//         mockGame.addPlayer("alice");
//         mockGame.addPlayer("bob");
//         mockGame.addPlayer("charlie");

//         dealerManager = new DealerPositionManager(mockGame);
//     });

//     describe("Initialization", () => {
//         test("should initialize dealer position with first active player", () => {
//             const dealerSeat = dealerManager.initializeDealerPosition();

//             expect(dealerSeat).toBe(1); // First active player
//             expect(mockGame.getDealerPosition()).toBe(1);
//         });

//         test("should throw error if not enough players", () => {
//             mockGame.setPlayers([new Player("alice", undefined, 1000n, undefined, PlayerStatus.ACTIVE)]);

//             expect(() => dealerManager.initializeDealerPosition()).toThrow("Not enough players to start the game");
//         });
//     });
...
//         mockDealerManager = {
//             initializeDealerPosition: jest.fn().mockReturnValue(1),
//             rotateDealer: jest.fn().mockReturnValue(2),
...
//             handleHeadsUpDealer: jest.fn().mockReturnValue(2),
...
// describe("DealerManagerFactory", () => {
//     test("should create real dealer manager", () => {
//         const mockGame = new MockGame();
//         mockGame.addPlayer("alice");
//         mockGame.addPlayer("bob");

//         const dealerManager = DealerManagerFactory.create(mockGame);

//         expect(dealerManager).toBeInstanceOf(DealerPositionManager);
//     });

//     test("should create mock dealer manager", () => {
//         const mockDealerManager = DealerManagerFactory.createMock();

//         expect(mockDealerManager).toBeInstanceOf(MockDealerPositionManager);
//         expect(mockDealerManager.getDealerPosition()).toBe(1); // Default mock behavior
//     });
// });

// // ==================== MOCK DEALER MANAGER TESTS ====================

// describe("MockDealerPositionManager", () => {
//     let mockDealer: MockDealerPositionManager;

//     beforeEach(() => {
//         mockDealer = new MockDealerPositionManager();
//     });

//     test("should provide consistent mock behavior", () => {
//         expect(mockDealer.getDealerPosition()).toBe(1);
//         expect(mockDealer.getSmallBlindPosition()).toBe(2);
//         expect(mockDealer.getBigBlindPosition()).toBe(3);
//     });

//     test("should allow setting positions for testing", () => {
//         (mockDealer as any).setDealerPosition(5);
//         (mockDealer as any).setBlindPositions(6, 1);

//         expect(mockDealer.getDealerPosition()).toBe(5);
//         expect(mockDealer.getSmallBlindPosition()).toBe(6);
//         expect(mockDealer.getBigBlindPosition()).toBe(1);
//     });

//     test("should rotate dealer position", () => {
//         const initialDealer = mockDealer.getDealerPosition();
//         const newDealer = mockDealer.rotateDealer();
...
// describe("DealerManager Performance", () => {
//     test("should handle large player rotations efficiently", () => {
//         const mockGame = new MockGame();

//         // Add many players
//         for (let i = 1; i <= 1000; i++) {
//             mockGame.addPlayer(`player${i}`);
//         }

//         const dealerManager = new DealerPositionManager(mockGame);

//         const start = performance.now();

//         // Rotate dealer 100 times
//         for (let i = 0; i < 100; i++) {
//             dealerManager.rotateDealer();
//         }
