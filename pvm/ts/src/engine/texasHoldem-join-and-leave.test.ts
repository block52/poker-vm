...
describe("Texas Holdem - Join and Leave", () => {
    ...
    describe("Player Management", () => {
        ...
        it("should not progress rounds without minimum players", () => {
            ...
            game.join(player1.address, ONE_HUNDRED_TOKENS); // Only one player
        ...
        it("should not be able to join more than once", () => {
            ...
            game.join("0x1fa53E96ad33C6Eaeebff8D1d83c95Fcd7ba9dac", ONE_HUNDRED_TOKENS);
            expect(() => {
                game.join("0x1fa53E96ad33C6Eaeebff8D1d83c95Fcd7ba9dac", ONE_HUNDRED_TOKENS);
        ...
        it("should not allow duplicate players", () => {
            game.join("0x1fa53E96ad33C6Eaeebff8D1d83c95Fcd7ba9dac", ONE_HUNDRED_TOKENS);
            expect(() => game.join("0x1fa53E96ad33C6Eaeebff8D1d83c95Fcd7ba9dac", ONE_HUNDRED_TOKENS)).toThrow();
        });
        ...
        it("should track player positions correctly", () => {
            game.join("0x1fa53E96ad33C6Eaeebff8D1d83c95Fcd7ba9dac", ONE_HUNDRED_TOKENS);
            game.join("0x980b8D8A16f5891F41871d878a479d81Da52334c", ONE_HUNDRED_TOKENS);
