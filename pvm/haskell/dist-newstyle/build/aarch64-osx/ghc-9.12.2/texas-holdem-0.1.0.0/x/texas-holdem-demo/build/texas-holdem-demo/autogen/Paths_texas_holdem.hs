...
-- at runtime using the environment variable texas_holdem_bindir.
...
-- environment variable texas_holdem_libdir.
...
-- using the environment variable texas_holdem_dynlibdir.
...
-- runtime using the environment variable texas_holdem_datadir.
...
-- variable texas_holdem_libexedir.
...
-- using the environment variable texas_holdem_sysconfdir.
...
bindir     = "/Users/lucascullen/.cabal/bin"
libdir     = "/Users/lucascullen/.cabal/lib/aarch64-osx-ghc-9.12.2-inplace/texas-holdem-0.1.0.0-inplace-texas-holdem-demo"
dynlibdir  = "/Users/lucascullen/.cabal/lib/aarch64-osx-ghc-9.12.2-inplace"
datadir    = "/Users/lucascullen/.cabal/share/aarch64-osx-ghc-9.12.2-inplace/texas-holdem-0.1.0.0"
libexecdir = "/Users/lucascullen/.cabal/libexec/aarch64-osx-ghc-9.12.2-inplace/texas-holdem-0.1.0.0"
sysconfdir = "/Users/lucascullen/.cabal/etc"

getBinDir     = catchIO (getEnv "texas_holdem_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "texas_holdem_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "texas_holdem_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "texas_holdem_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "texas_holdem_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "texas_holdem_sysconfdir") (\_ -> return sysconfdir)
